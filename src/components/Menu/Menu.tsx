...
export default function Menu() {
  ...
  const hiddenWord = random(selectedTopic.words);

  if (inGameScreen) {
    return (
      <>
        <InGame hiddenWord={hiddenWord} />
      </>
    );
  }
  ...
  return (
    <div className="container mt-8">
      ...
      <Button
        name={"Play"}
        className={
          "mx-auto mb-5 block rounded-xl border-4 border-red500 px-4 py-2 text-3xl text-red500"
        }
